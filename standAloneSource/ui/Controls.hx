...
class Controls extends flixel.FlxBasic {
	...
	static public var useKeys(get, never):Bool;

	inline static function get_useKeys()
		return mode == Keys;

	static public var useTouch(get, never):Bool;

	inline static function get_useTouch()
		return mode == Touch;

	static public var usePad(get, never):Bool;

	inline static function get_usePad()
		return mode == Gamepad;
...
class ControlsList {
	...
	inline function get_UP()
		return check(Action.UP);

	public var DOWN(get, never):Bool;

	inline function get_DOWN()
		return check(Action.DOWN);

	public var LEFT(get, never):Bool;

	inline function get_LEFT()
		return check(Action.LEFT);

	public var RIGHT(get, never):Bool;

	inline function get_RIGHT()
		return check(Action.RIGHT);

	public var A(get, never):Bool;

	inline function get_A()
		return check(Action.A);

	public var B(get, never):Bool;

	inline function get_B()
		return check(Action.B);
